...
export default function InformationOption({title, text, styles, innerStyles, children}: InformationOptionProps) {
    return (
    <div className={`group border-transparent px-5 py-2 transition-colors \
                    ...
                    hover:dark:bg-purple-900/20 dark:border-yellow-900/50  my-2 rounded-md \
                                dark:bg-[url('/bg1.jpg')] ${styles} `}>
        <div className='flex items-center justify-between'>
        <div className={`w-full ${innerStyles}`}>
            <div className='my-2'>
