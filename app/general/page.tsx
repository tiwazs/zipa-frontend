...
export default function ItemsPage() {    
    ...
    <main className="items-center justify-between p-24">
        ...
        <InformationOption styles='w-full border-4' innerStyles='flex space-y-10'>
            <InformationOption title='ZIPA' styles='w-full border-1'>
                Zipa is a grand campaign game combining elements of strategy, rpg and roguelike games.
            </InformationOption>
            <InformationOption title='' styles='w-full'>
            ...
            <InformationOption title='FACTIONS' styles='w-full'>
            ...
            <InformationOption title='UNITS' styles='w-full'>
            ...
            <InformationOption title='COMBAT' styles='w-full'>
            ...
            <InformationOption title='ACTIONS AND DAMAGE' styles='w-full'>
            ...
            <InformationOption title='ITEMS' styles='w-full'>
