...
export default function NewOptionDialog({ title, description, selection, beliefId, styles}: Readonly<NewOptionDialogProps>) {
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl p-6 text-left shadow-xl transition-all 
                  ...
                  <div className="mt-2 flex flex-col space-y-6">
                    ...
                    {(selection === "traits") ? <TraitSelection beliefId={beliefId} /> 
                        : (selection === "specializations") ? <SpecializationSelection beliefId={beliefId} />
                        : null }
                    <button
                      type="button"
