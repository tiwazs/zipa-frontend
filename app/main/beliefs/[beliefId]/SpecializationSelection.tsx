...
export default function SpecializationSelection({beliefId}: Readonly<SkillSelectionProps>) {
    ...
    const onAddSkill = async () => {
      ...
      try{
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/beliefs/add_unit/${beliefId}?unit_id=${selected.id}`, {
            method: "PUT",
            headers: {
