...
interface CultureUnitsDisclosureProps {
    cultureId: string;
    disclosureInformationList: DisclosureInformation[];
}

export default function CultureUnitsDisclosure({ cultureId, disclosureInformationList }: Readonly<CultureUnitsDisclosureProps>) {
                ...
                <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                  ...
                  {disclosureInformation.information.map((unit: any) => (
                    <SpecializationOption 
                                        ...
                                        items={unit.items}
                                        traits={unit.traits}
                                        removeEndpoint={`/cultures/remove_unit/${cultureId}?unit_id=`}
                                        endpointMethod='PUT'
                                        queryInvalidateKey='cultureSpecializations'
