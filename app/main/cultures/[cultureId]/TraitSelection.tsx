...
export default function SkillSelection({cultureId}: Readonly<SkillSelectionProps>) {
    ...
    const onAddSkill = async () => {
      ...
      try{
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/cultures/add_trait/${cultureId}?trait_id=${selected.id}`, {
            method: "PUT",
            headers: {
