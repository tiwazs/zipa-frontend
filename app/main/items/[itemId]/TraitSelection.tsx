...
export default function SkillSelection({itemId}: Readonly<SkillSelectionProps>) {
    ...
    const onAddSkill = async () => {
      ...
      try{
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/items/add_trait/${itemId}?trait_id=${selected.id}`, {
            method: "PUT",
            headers: {
