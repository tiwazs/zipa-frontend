...
export default function RacesPage() {    
    ...
    <main className="items-center justify-between p-24">
        ...
        <div className='flex'>
            <NewRaceDialog styles="group rounded-lg border border-transparent px-3 py-2 transition-colors border-4 hover:dark:dark:border-yellow-900/50 hover:bg-black 
