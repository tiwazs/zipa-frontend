    ...
    return (
        <div className='group my-2 px-4 py-2 font-light dark:border-2 rounded-md dark:border-yellow-900/50 flex items-center justify-between '>
            ...
            <div className='flex items-center space-x-3'>
                ...
                <p>
                    <Link href={`/main/effects/${skilleffect.effect.id}`}><span className='text-yellow-400 font-normal'>{effect.name}</span></Link> lasting <span className='text-purple-400'>{skilleffect.duration}</span> T
                </p>
            </div>
            <p>
                ...
                <div className='px-4 flex flex-col font-extralight italic space-x-2 '>
                    ...
                    <DisplayValue previous_text='Target: ' value={effect.instant_target !== "SELF" ? effect.instant_target : "0"}/>
