                ...
                <div className='mx-2'>
                    ...
                    <div className='flex space-x-10'>
                        ...
                        <div>
                            ...
                            <div className='flex items-center space-x-2'>
                                ...
                                <h1>Load Capacity</h1>
                                <h1 className='my-2 py-3 text-orange-500 font-light'>{unit.specialization.load_capacity + (unit.strength*0.25)}</h1>
                            </div>
                            <div className='flex items-center space-x-2'>
                                <img src={`/gen_icons/weight.png`} alt="" className='w-7 h-7 rounded-full border border-yellow-500/60 my-2' />
                                <h1>Weight</h1>
                    ...
                    <div className='items-center space-x-2 col-span-4 my-4'>
                        ...
                        {(unit.items && unit.items.length > 0) ? unit.items.map((item: any) => {
                            return <ItemCard key={item.item.id} ownerId={unit.id} OwnerItem={item} editable={editing} deleteEndpoint={`/units/remove_item/${unit.id}?item_id=`} invaildateQueryKey={'unit'}  />
                        }) : <h1 className='px-4 text-gray-400'>N/A</h1>}
                    </div>
                </div>
